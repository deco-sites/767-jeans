  ...
  return (
    ...
    >
      <form
        ...
        action={ACTION}
        class="flex items-center justify-between w-full border-b py-1.5"
      >
        <input
          autoFocus
          tabIndex={0}
          class="flex flex-grow focus:outline-none placeholder:text-black"
          name={NAME}
        ...
        >
          ...
          <Icon
            id="search"
            class="inline [.htmx-request_&]:hidden text-error"
          />
        </button>
      </form>
